...
export default function ExampleQuiz() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 py-8 sm:py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-10 text-center border-4 border-emerald-300">
            <div className="mb-6">
            ...
            <div className="mb-6">
              <div className="text-5xl sm:text-6xl md:text-7xl font-bold bg-gradient-to-r from-emerald-500 to-teal-600 text-transparent bg-clip-text mb-3">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 py-4 sm:py-8 px-3 sm:px-4">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="bg-white rounded-3xl shadow-xl p-4 sm:p-6 mb-4 sm:mb-6 border-2 border-emerald-200">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 mb-4">
            <div className="flex-1">
              ...
              <p className="text-xs sm:text-sm text-gray-600">
                Estudia preguntas que piden ejemplos de conceptos
              </p>
            </div>
            {!reviewMode && (
              <div className="text-center sm:text-right bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl px-4 sm:px-6 py-2 sm:py-3 shadow-lg">
          ...
          <div className="flex items-center gap-2 sm:gap-4 mb-4">
            <div className="flex-1 bg-emerald-100 rounded-full h-3 sm:h-4 overflow-hidden">
              <div
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            <span className="inline-block px-3 py-1.5 bg-emerald-100 text-emerald-800 rounded-full text-xs sm:text-sm font-semibold shadow-sm">
              {currentQuestion.category}
            </span>
            <span className="inline-block px-3 py-1.5 bg-teal-100 text-teal-800 rounded-full text-xs sm:text-sm font-semibold shadow-sm">
              {currentQuestion.concept}
            </span>
            <Link
              href="/"
              className="ml-auto text-xs sm:text-sm text-emerald-600 hover:text-emerald-700 hover:underline font-semibold"
            >
              ← Volver al Menú
            </Link>
          </div>
        ...
        {/* Question Card */}
        <div className="bg-white rounded-3xl shadow-xl p-5 sm:p-8 mb-4 sm:mb-6 border-2 border-emerald-200">
          <div className="mb-4 p-3 sm:p-4 bg-yellow-50 border-l-4 border-yellow-500 rounded-xl shadow-sm">
            <p className="text-xs sm:text-sm text-yellow-800 font-semibold">
              💡 Este tipo de pregunta pide ejemplos específicos del concepto
            </p>
          </div>
            ...
            {currentQuestion.options.map((option, index) => {
              ...
              if (showExplanation) {
                ...
                if (selectedAnswer === index) {
                  buttonClass += "bg-emerald-100 border-emerald-500 text-emerald-800 shadow-md";
                } else {
                  buttonClass += "bg-gray-50 border-gray-300 text-gray-700 hover:border-emerald-400 hover:bg-emerald-50 hover:shadow-sm";
                }
              }
          ...
          {showExplanation && (
            <div className="mt-4 sm:mt-6 p-4 sm:p-5 bg-emerald-50 border-l-4 border-emerald-500 rounded-r-xl shadow-sm">
              <h3 className="font-bold text-emerald-800 mb-2 text-base sm:text-lg">
                💡 Explicación:
              </h3>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-between mb-4 sm:mb-6">
          ...
          {!showExplanation ? (
            <button
              ...
              className="px-5 sm:px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl hover:from-emerald-600 hover:to-teal-700 transition-all duration-300 font-bold text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-105 disabled:transform-none"
            >
              ✅ Verificar Respuesta
            </button>
          ) : (
            <button
              ...
              className="px-5 sm:px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl hover:from-emerald-600 hover:to-teal-700 transition-all duration-300 font-bold text-sm sm:text-base shadow-lg hover:shadow-xl transform hover:scale-105"
            >
        ...
        <div className="bg-white rounded-3xl shadow-xl p-4 sm:p-6 border-2 border-emerald-200">
