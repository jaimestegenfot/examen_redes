    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 py-8 sm:py-12 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-6 sm:p-10 text-center border-4 border-green-300 relative overflow-hidden">
            {/* Efecto de brillo */}
            ...
            <div className="relative z-10 mb-6">
              <div className="text-5xl sm:text-6xl md:text-7xl font-bold bg-gradient-to-r from-green-500 via-emerald-600 to-teal-600 text-transparent bg-clip-text mb-3 animate-pulse">
              ...
              <div className="mt-4 max-w-md mx-auto">
                <div className="h-4 bg-gray-200 rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 rounded-full transition-all duration-1000 shadow-lg"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 py-4 sm:py-8 px-3 sm:px-4 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute top-40 right-10 w-96 h-96 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-20 left-1/2 w-96 h-96 bg-teal-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
      </div>

      <div className="max-w-4xl mx-auto relative z-10">
        {/* Header con diseño mejorado */}
        <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl p-4 sm:p-6 mb-4 sm:mb-6 border-4 border-green-300 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 mb-4">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 text-transparent bg-clip-text">
                  📚 Repaso de Redes
                </h1>
              </div>
              <p className="text-xs sm:text-sm text-gray-600 ml-5">Quiz Principal - 100 preguntas</p>
            </div>
            {!reviewMode && (
              <div className="text-center sm:text-right bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 text-white rounded-2xl px-4 sm:px-6 py-2 sm:py-3 shadow-xl transform hover:scale-105 transition-transform">
          ...
          <div className="flex items-center gap-2 sm:gap-4 mb-4">
            <div className="flex-1 bg-green-100 rounded-full h-4 sm:h-5 overflow-hidden shadow-inner border-2 border-green-200">
              <div
                className="bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 h-full rounded-full transition-all duration-500 shadow-lg relative overflow-hidden"
                style={{
            ...
            <span className="text-xs sm:text-sm font-bold text-gray-700 whitespace-nowrap bg-green-50 px-3 py-1 rounded-full border-2 border-green-300">
              {currentQuestionIndex + 1} / {shuffledQuestions.length}
            </span>
          </div>
          
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            <span className="inline-block px-3 py-1.5 bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 rounded-full text-xs sm:text-sm font-semibold shadow-md border-2 border-green-300">
        ...
        <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl p-5 sm:p-8 mb-4 sm:mb-6 border-4 border-green-300 relative overflow-hidden">
            ...
            {currentQuestion.options.map((option, index) => {
              ...
              if (showExplanation) {
                ...
                if (selectedAnswer === index) {
                  ...
                  buttonClass += "bg-gray-50 border-gray-300 text-gray-700 hover:border-green-400 hover:bg-green-50 hover:shadow-md hover:scale-102";
                }
              }
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 relative z-10">
                    <span className="font-bold text-base sm:text-lg mt-0.5 flex-shrink-0 w-8 h-8 flex items-center justify-center bg-green-500 text-white rounded-lg shadow-md">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-between mb-4 sm:mb-6">
          ...
          {!showExplanation ? (
            <button
              ...
              className="px-5 sm:px-6 py-3 bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 text-white rounded-xl hover:from-green-600 hover:via-emerald-600 hover:to-teal-600 transition-all duration-300 font-bold text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed shadow-xl hover:shadow-2xl transform hover:scale-110 active:scale-95 disabled:transform-none relative overflow-hidden"
            >
            ...
            <button
              ...
              className="px-5 sm:px-6 py-3 bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 text-white rounded-xl hover:from-green-600 hover:via-emerald-600 hover:to-teal-600 transition-all duration-300 font-bold text-sm sm:text-base shadow-xl hover:shadow-2xl transform hover:scale-110 active:scale-95 relative overflow-hidden"
            >
        ...
        <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-xl p-4 sm:p-6 border-4 border-green-300 relative overflow-hidden">
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400"></div>
              ...
              <button
                ...
                className={`p-1.5 sm:p-2 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-200 border-2 ${
                  index === currentQuestionIndex
                    ? 'bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-xl scale-110 border-green-600'
                    : answeredQuestions.has(q.id)
                    ? 'bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 border-green-400 hover:bg-green-200 shadow-md'
                    : 'bg-gray-100 text-gray-700 border-gray-300 hover:bg-gray-200 hover:border-green-300'
                }`}
              >
                {index + 1}
              </button>
        ...
        {/* Footer */}
        <footer className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t-2 border-green-200">
          <div className="text-center">
